...
class Widgets_For_Google_Reviews_And_Ratings_Admin {
    ...
    public function enqueue_styles() {
        if (isset($_GET['page']) && sanitize_text_field($_GET['page']) === 'google-reviews-settings') {
            $style_file = $this->is_min ? 'css/widgets-for-google-reviews-and-ratings-admin.min.css' : 'css/widgets-for-google-reviews-and-ratings-admin.css';
            wp_enqueue_style($this->plugin_name, plugin_dir_url(__FILE__) . $style_file, [], $this->version, 'all');
        }
    }

    public function enqueue_scripts() {
        if (isset($_GET['page']) && sanitize_text_field($_GET['page']) === 'google-reviews-settings') {
            $script_file = $this->is_min ? 'js/widgets-for-google-reviews-and-ratings-admin.min.js' : 'js/widgets-for-google-reviews-and-ratings-admin.js';
            wp_enqueue_script($this->plugin_name, plugin_dir_url(__FILE__) . $script_file, ['jquery'], $this->version, false);
    ...
    public function wgrr_widget_customizer_select_layout_setting() {
        try {
            ...
            <div id="wgrr_accordion">
                <h2 class="select-layout-title"><?php echo __('Select Layout', 'widgets-for-google-reviews-and-ratings'); ?></h2>
                <div class="layout-section">
                    <div class="layout-header-with-shodtcode">
                        <div class="layout-row">
                            <h3><?php echo __('Layout: Slider', 'widgets-for-google-reviews-and-ratings'); ?></h3>
                            <div class="shortcode-container">
                                <span><?php echo __('Your Shortcode:', 'widgets-for-google-reviews-and-ratings'); ?></span>
                                ...
                                <button class="repocean-btn repocean-tooltip">
                                    <?php echo __('Copy to Clipboard', 'widgets-for-google-reviews-and-ratings'); ?>
                                    <span class="repocean-tooltip-message" style="opacity: 0;"><?php echo __('Copied!', 'widgets-for-google-reviews-and-ratings'); ?></span>
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="layout-section">
                    <div class="layout-header-with-shodtcode">
                        <div class="layout-row">
                            <h3><?php echo __('Layout: Grid', 'widgets-for-google-reviews-and-ratings'); ?></h3>
                            <div class="shortcode-container">
                                <span><?php echo __('Your Shortcode:', 'widgets-for-google-reviews-and-ratings'); ?></span>
                ...
                <div class="layout-section">
                    <div class="layout-header-with-shodtcode">
                        <div class="layout-row">
                            <h3><?php echo __('Layout: List', 'widgets-for-google-reviews-and-ratings'); ?></h3>
                            <div class="shortcode-container">
                                <span><?php echo __('Your Shortcode:', 'widgets-for-google-reviews-and-ratings'); ?></span>
                ...
                <div class="layout-section">
                    <div class="layout-header-with-shodtcode">
                        <div class="layout-row">
                            <h3><?php echo __('Layout: Sidebar', 'widgets-for-google-reviews-and-ratings'); ?></h3>
                            <div class="shortcode-container">
                                <span><?php echo __('Your Shortcode:', 'widgets-for-google-reviews-and-ratings'); ?></span>
    ...
    public function wgrr_widget_customizer_get_settings_setting() {
        try {
            if (isset($_POST['repocean_submit'])) {
                ...
                echo '<div class="notice notice-success is-dismissible"><p>' . __('Settings saved successfully!', 'widgets-for-google-reviews-and-ratings') . '</p></div>';
            }
            ...
            echo '<div class="notice notice-error"><p>' . __('An error occurred while saving the settings. Please try again.', 'widgets-for-google-reviews-and-ratings') . '</p></div>';
        }
    }
